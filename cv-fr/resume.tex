...
% Date en pied de page (sans numéros de page)
\newcommand{\cvFooterDate}{août 2026}
\makecvfooter
  {}
  {\cvFooterDate}
  {}
...
% Projets sélectionnés (index-fr.html seulement ; brouillon dans latex/projects.tex) :
